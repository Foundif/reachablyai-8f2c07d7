        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="text-center">
            <div className="w-24 h-24 mx-auto mb-6 rounded-2xl flex items-center justify-center shadow-glow animate-pulse-ring">
              <img src={logoAsset.url} alt="Reachably" className="h-16 w-auto object-contain" />
            </div>
            <h2 className="text-3xl font-bold text-foreground mb-4">Welcome to Reachably</h2>
      ...
      case 5:
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="text-center">
            ...
            <p className="text-muted-foreground mb-8">Here's what you can do with Reachably</p>
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 md:p-6">
        <div className="flex items-center gap-2">
          <img src={logoAsset.url} alt="Reachably" className="h-7 w-auto object-contain" />
        </div>
