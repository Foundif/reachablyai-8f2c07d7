        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-md">
              Billing, appointments, customer tracking, AI agents, broadcast campaigns and analytics — all in one workspace.
            </p>
          </motion.div>
          ...
          {isResettingPassword ? (
            ...
            <>
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">{isLogin ? 'Sign in to manage your salon' : 'Start managing your salon & spa today'}</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input id="email" type="email" placeholder="you@salon.com" value={email} onChange={(e) => setEmail(e.target.value)} required className="pl-10 bg-card border-border focus:border-primary" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" />
                    <Input id="password" type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} className="pl-10 bg-card border-border focus:border-primary" />
                  </div>
                </div>
              ...
              <Button type="button" variant="outline" size="lg" className="w-full" disabled={googleLoading}
                onClick={async () => {
